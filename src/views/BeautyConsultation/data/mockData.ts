...
export const consultationServices: ConsultationService[] = [
  {
    ...
    description: 'Get a detailed skin analysis and a customized skincare routine based on your unique needs and concerns.',
  ...
  },
  {
    ...
    description: 'Học các kỹ thuật trang điểm phù hợp với khuôn mặt, tông da và phong cách sống của bạn cùng chuyên gia trang điểm.',
  ...
  },
  {
    ...
    description: 'Kỹ thuật trang điểm chuyên nghiệp cho các sự kiện đặc biệt, dạ tiệc, và lễ cưới với các sản phẩm cao cấp.',
  ...
  },
  {
    ...
    description: 'Phân tích chuyên sâu về khuôn mặt và tone màu, cùng tư vấn cá nhân hóa về kỹ thuật trang điểm phù hợp với cá tính.',
  ...
  },
  {
    ...
    description: 'Tư vấn chuyên sâu về trang điểm cô dâu, phối hợp màu sắc với váy cưới và hoa cưới, kèm thử nghiệm trang điểm.',
  ...
  },
  {
    ...
    description: 'Hướng dẫn điều chỉnh kỹ thuật và sản phẩm trang điểm phù hợp với từng mùa trong năm và tông màu của trang phục.',
  ...
  },
  {
    ...
    description: 'Find your perfect hair style and color with expert advice tailored to your face shape, lifestyle, and preferences.',
  ...
  },
  {
    ...
    description: 'Comprehensive analysis and personalized treatment plan to address aging concerns with cutting-edge solutions.',
  ...
  },
  {
    ...
    description: 'Holistic approach to body care including nutrition, exercise, and skincare recommendations for overall wellness.',
