...
export const consultantInfo: ConsultantInfo[] = [
  {
    ...
    experience: 7,
    description:
      'Trần Thu Hà là chuyên gia trang điểm với hơn 7 năm kinh nghiệm làm việc tại các show thời trang và sự kiện lớn. Cô nổi tiếng với phong cách trang điểm tự nhiên nhưng vẫn tôn lên vẻ đẹp riêng của từng khách hàng.',
  ...
  },
  {
    ...
    experience: 9,
    description:
      'Nguyễn Minh Tâm là chuyên gia trang điểm sự kiện với hơn 9 năm kinh nghiệm, đặc biệt chuyên sâu về trang điểm dự tiệc và sự kiện đặc biệt. Anh đã trang điểm cho nhiều nghệ sĩ và người nổi tiếng tại các sự kiện lớn.',
  ...
  },
  {
    ...
    experience: 5,
    description:
      'Lê Quỳnh Anh chuyên về tư vấn trang điểm cá nhân hóa, giúp mỗi khách hàng tìm ra phong cách trang điểm phù hợp nhất với đặc điểm khuôn mặt và cá tính riêng. Cô từng tu nghiệp tại Hàn Quốc và Nhật Bản.',
  ...
  },
  {
    ...
    experience: 10,
    description:
      'Vũ Thanh Thảo là chuyên gia trang điểm cô dâu với 10 năm kinh nghiệm, đã giúp hàng trăm cô dâu tỏa sáng trong ngày trọng đại. Cô đặc biệt giỏi trong việc tạo ra vẻ đẹp rạng rỡ nhưng vẫn giữ được nét tự nhiên.',
  ...
  },
  {
    ...
    experience: 8,
    description:
      'Hoàng Lan Phương là chuyên gia trang điểm thời trang với 8 năm kinh nghiệm làm việc tại các sàn catwalk, tạp chí và chiến dịch quảng cáo. Cô luôn cập nhật xu hướng mới nhất và có khả năng điều chỉnh cho phù hợp với người Á Đông.',
