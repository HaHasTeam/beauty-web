...
export default function About() {
  return (
    <div className="w-full my-8">
      <div className="w-full px-lg-32 px-md-28 px-sm-16 px-10">
        <div className="mx-auto mb-8">
          ...
          <div className="grid sm:grid-cols-2 gap-8 items-center mb-12">
            <div>
              <p className="text-lg mb-4">
                At Allure, we believe that beauty is personal, and so should your skincare and makeup choices. We are
                more than just an ecommerce store. Allure is a comprehensive beauty consulting platform that combines
                beauty enthusiasts with certified beauty consultants to provide personalized advice, recommendations,
                and access to top-tier beauty products.
              </p>
          ...
          <div className="bg-background rounded-xl">
            <h2 className="text-2xl text-primary font-bold text-center mb-4">Our Mission & Vision</h2>
        ...
        <div className="mx-auto">
          <h2 className="text-2xl text-primary font-bold text-center mb-2">What We Offer</h2>
          ...
          <div className="bg-background rounded-xl mb-10">
            <h3 className="text-2xl text-primary font-bold text-center mb-8">Why choose us?</h3>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 ">
              {[
                ...
                },
                {
                  ...
                  description:
                    'From beauty consulting to shopping and support, find every beauty service you need here.',
                },
              ].map((item, index) => (
                <div key={index} className="text-center bg-accent p-2 rounded-md">
          ...
          <div className="text-center mb-16 ">
            <h3 className="text-2xl text-primary font-bold mb-4">Our Commitment to Quality & Inclusivity</h3>
            <p className="text-gray-600">
              We believe that beauty should be inclusive and accessible to everyone. Our platform is designed to serve a
              wide range of skin types, tones, and concerns. From personalized skincare routines to makeup tutorials
              that work for diverse features, we are committed to helping everyone feel beautiful and confident. Our
              consultants are trained in inclusive beauty practices, and our product selection reflects our commitment
              to diversity. When you shop with us, you can trust that you're getting high-quality products that align
              with our commitment to quality, ensuring that each item we offer meets the highest standards.
            </p>
          </div>

          <div className="text-center bg-background rounded-xl">
            <h3 className="text-2xl text-primary font-bold mb-4">Get in Touch</h3>
