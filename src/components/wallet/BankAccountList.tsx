  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      successToast({
        ...
        description: t(
          'wallet.bankAccounts.deleteSuccessDescription',
    ...
    onError: (error) => {
      ...
      errorToast({
        ...
        description: t(
          'wallet.bankAccounts.deleteErrorDescription',
  ...
  const setDefaultMutation = useMutation({
    ...
    onSuccess: () => {
      successToast({
        ...
        description: t(
          'wallet.bankAccounts.defaultSuccessDescription',
    ...
    onError: (error) => {
      ...
      errorToast({
        ...
        description: t(
          'wallet.bankAccounts.defaultErrorDescription',
  ...
  if (accounts.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center border-2 border-dashed border-gray-200 rounded-lg bg-gray-50">
        ...
        <h3 className="text-lg font-medium text-gray-800">{t('wallet.bankAccounts.noAccounts')}</h3>
        <p className="text-gray-500 mt-2 max-w-sm">{t('wallet.bankAccounts.addYourFirst')}</p>
        <Button
          variant="outline"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t(
                'wallet.bankAccounts.deleteConfirmDescription',
