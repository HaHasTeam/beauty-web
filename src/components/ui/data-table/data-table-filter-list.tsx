...
import { getDefaultFilterOperator, getFilterOperators } from '@/lib/dataTable'
import { getFiltersStateParser } from '@/lib/parsers'
import { cn, formatDate } from '@/lib/utils'
import type { DataTableAdvancedFilterField, Filter, FilterOperator, JoinOperator, StringKeyOf } from '@/types/table'
                      ...
                      <PopoverTrigger asChild>
                        ...
                        >
                          <span className="truncate">
                            {filterFields.find((field) => field.id === filter.id)?.label ?? 'Select field'}
                          </span>
