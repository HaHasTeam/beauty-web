        ...
        {showForm && (
          <div className="flex text-gray-12">
            ...
            <div className="flex flex-col text-sm font-semibold">
              <p>
                {new Date('2025-04-04' as string).toLocaleString(locale, {
                  dateStyle: 'full',
                })}
              </p>
              <p>
                {new Date('2025-04-04 10:00:00' as string).toLocaleString(locale, {
                  timeStyle: 'short',
                })}
              </p>
            </div>
        ...
        <Select value={timeZone} onValueChange={setTimeZone}>
          ...
          <SelectContent className="w-fit dark:bg-gray-5">
            {timeZones.map((timeZone) => (
              <SelectItem key={timeZone.label} value={timeZone.tzCode} className="dark:focus:bg-gray-2">
