...
export function RightPanel({ handleChangeAvailableTime, selectedTime }: RightPanelProps) {
          ...
          return (
            <Button
              ...
              className={cn(
                ...
                isSelected
                  ? ['bg-primary text-primary-foreground font-bold shadow-lg scale-105 border-primary/80'].join(' ')
                  : ['hover:bg-primary/10 hover:text-primary hover:border-primary/40'].join(' '),
              )}
