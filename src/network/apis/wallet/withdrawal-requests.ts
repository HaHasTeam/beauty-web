...
export const getWithdrawalRequestsApi = toQueryFetcher<WithdrawalRequestFilterParams, TServerResponseWithPagination<IWithdrawalRequest[]>>(
  'getWithdrawalRequestsApi', 
  async (params?: WithdrawalRequestFilterParams) => {
