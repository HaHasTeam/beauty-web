...
import type { DataTableFilterField, DataTableQueryState, ExtendedSortingState } from '@/types/table'
...
interface UseDataTableProps<TData>
  ...
  queryStates?: [DataTableQueryState<TData>, React.Dispatch<React.SetStateAction<DataTableQueryState<TData>>>]
}
